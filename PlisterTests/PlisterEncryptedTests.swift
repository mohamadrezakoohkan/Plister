...
class PlisterEncryptedTests: XCTestCase {
    ...
    func testJsonDecrypt() {
        ...
        PAssert(result as? [String: String],input.data)
    }
    
    func testJsonSetEncrypt() {
        let input = self.json
        self.plist.set(input.data, for: input.key)
        PAssert(self.plist.dictionary(input.key) as? [String: String],input.data)
    }
    ...
    func testCollectionDecrypt() {
        ...
        PAssert(result as? [String],input.data)
    }
    
    func testCollectionSetEncrypt() {
        let input = self.collection
        self.plist.set(input.data, for: input.key)
        PAssert(self.plist.collection(input.key) as? [String],input.data)
    }
    ...
    func testStringSetEncrypt() {
         let input = self.string
         self.plist.set(input.data, for: input.key)
         PAssert(self.plist.string(input.key),input.data)
     }
    ...
    func testBoolSetEncrypt() {
        let input = self.bool
        self.plist.set(input.data, for: input.key)
        PAssert(self.plist.bool(input.key),input.data)
    }
    ...
    func testIntSetEncrypt() {
        let input = self.int
        self.plist.set(input.data, for: input.key)
        PAssert(self.plist.int(input.key),input.data)
    }
    ...
    func testDoubleSetEncrypt() {
        let input = self.double
        self.plist.set(input.data, for: input.key)
        PAssert(self.plist.double(input.key),input.data)
    }
    ...
    func testFloatSetEncrypt() {
        let input = self.float
        self.plist.set(input.data, for: input.key)
        PAssert(self.plist.float(input.key),input.data)
    }
    ...
    func testDateDecrypt() {
        ...
        let dif = input.data.timeIntervalSince(result!)
    ...
    func testDateEncrypt() {
        let input = self.date
        self.plist.set(input.data, for: input.key)
        PAssert(self.plist.date(input.key),input.data)
    }
